...
The package is now avaailable from Melpa repository, so if you have it in your
package repository, you can install it either via package-install, or elget.

If you are using use-package you can just do:
